...
func main() {
	...
	doctors = append(doctors, Doctor{Id: "1", Firstname: "Andrei", Lastname: "Tanenbaum", Email: "a.tanenbaum@minix.net", Age: 44, University: "Carolina Davila", Specialty: "Chirurg", Title: "Domnu'"})
	...
	responses = append(responses, Response{Id: "1", Doctor_id: "1", Question_id: "1", Content: "Va recomand un coldrex."})
	responses = append(responses, Response{Id: "2", Doctor_id: "1", Question_id: "2", Content: "Luati un theraflu, nu mai mancati fasole si mancati alune."})
	responses = append(responses, Response{Id: "2", User_id: "1", Question_id: "2", Content: "Eu as recomanda un smoothie de banane, mar si morcovi!"})
